...
internal static class MoveDictionaries
{
    ...
    public static List<Point> GetKnightTranslations()
    {
        var PieceTranslations = new List<Point>()
            {
                new Point(-2,1),
                new Point(-2,-1),
                new Point(2,1),
    ...
    public static Dictionary<string, Point> GetPawnTranslations()
    {
        var PieceTranslations = new Dictionary<string, Point>();
        PieceTranslations.Add("base", new Point(0, 1));
        PieceTranslations.Add("attackE", new Point(1, 1));
        PieceTranslations.Add("attackW", new Point(-1, 1));
        return PieceTranslations;
    }
}
